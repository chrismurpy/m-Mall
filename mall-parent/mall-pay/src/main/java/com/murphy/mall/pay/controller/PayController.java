package com.murphy.mall.pay.controller;

import com.alipay.api.AlipayApiException;
import com.alipay.api.AlipayClient;
import com.alipay.api.request.AlipayTradePagePayRequest;
import com.murphy.mall.pay.config.AlipayUtils;
...
public class PayController {
    ...
    public void pay(String WIDout_trade_no, String WIDsubject, String WIDtotal_amount, String WIDbody, HttpServletResponse response)
        ...
        alipayTradePagePayRequest.setNotifyUrl(AlipayUtils.notify_url);
        alipayTradePagePayRequest.setReturnUrl(AlipayUtils.return_url);
        //4.设置请求的参数(传递给支付宝的数据)
