            ...
            <Form ref="formData" :model="formData" :label-width="80">
                <Row style="margin-top: 10px;">
                    ...
                    <FormItem label="地址" prop="address">
                        <Input v-model="formData.address" placeholder="地址"></Input>
                    </FormItem>
                    </Col>
                    <Col span="8">
        ...
        <div>
            <zk-table
                ...
                <template slot="action" slot-scope="scope">
                    ...
                    <Button type="primary" size="small" @click="edit(scope.row.id)" style="margin-left: 2px">修改</Button>
                    <Button type="primary" size="small" @click="remove(scope.row.id)" style="margin-left: 2px">删除</Button>
                </template>
            </zk-table>
        </div>
    </div>
